export const institutionsUtils = {
  ...
  alumniSuccess: [
    ...
    {
      description:
        "Influential political leader and advocate for social justice.",
    },
    {
...
export const institutionsData = [
  ...
  },
  {
    ...
    programsIds: [3, 4],
    facultyIds: [3, 4],
    extraActivitiesIds: [3, 4],
    costIds: [3, 4],
    alumniSuccessIds: [3, 4],
    insfrastructureIds: [3, 4],
    thumbnail:
  ...
  },
  {
    ...
    programsIds: [1, 4],
    facultyIds: [1, 4],
    extraActivitiesIds: [1, 4],
    costIds: [1, 4],
    alumniSuccessIds: [1, 4],
    insfrastructureIds: [1, 4],
    thumbnail:
      "https://res.cloudinary.com/dvj4qsyeu/image/upload/v1709734892/col1_ug89l9.jpg",
  ...
  {
    name: "Innovative High School",
    description: "Delivering High Quality Education with Innovative Approach",
    albumIds: [1, 2],
    programsIds: [2, 4],
    facultyIds: [2, 4],
    extraActivitiesIds: [2, 4],
    costIds: [2, 4],
    alumniSuccessIds: [2, 4],
    insfrastructureIds: [2, 4],
    thumbnail:
      "https://res.cloudinary.com/dvj4qsyeu/image/upload/v1709735203/high_u7svio.jpg",
    address: "Fulbari, Kathmandu",
    type: "High School",
    category: "Private",
    accreditation_status: "Accredited",
  ...
  {
    name: "Bindeswari Secondary School ",
    albumIds: [1, 2],
    programsIds: [1, 2],
    facultyIds: [1, 2],
    extraActivitiesIds: [1, 2],
