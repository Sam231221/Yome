...
/*
The Container component is imported dynamically using dynamic from @/components/Call/Container. This allows for lazy-loading the Container component when needed.
